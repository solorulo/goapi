...
import (
	...
	_ "goapi/app"
	controllers "goapi/app/controllers"
	tests "goapi/tests"
)
	...
	revel.RegisterController((*controllers.Users)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Add",
				Args: []*revel.MethodArg{ 
					&revel.MethodArg{Name: "nombre", Type: reflect.TypeOf((*string)(nil)) },
					&revel.MethodArg{Name: "apellido", Type: reflect.TypeOf((*string)(nil)) },
					&revel.MethodArg{Name: "email", Type: reflect.TypeOf((*string)(nil)) },
